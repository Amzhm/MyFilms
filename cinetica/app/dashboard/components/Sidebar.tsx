...
export const Sidebar = ({ children }: PropsWithChildren) => {
    ...
    return (
        <div className="bg-gray-200 h-full p-4" style={{ gridArea: 'sidebar' }}>
            ...
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'discover' ? 'bg-gray-300' : ''}`}
            ...
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'popularMovies' ? 'bg-gray-300' : ''}`}
                onClick={() => handleItemClick('popularMovies')}
            >
                <Star className="w-5 h-5 mr-2" /> Popular
            </button>
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'nowPlaying' ? 'bg-gray-300' : ''}`}
                onClick={() => handleItemClick('nowPlaying')}
            >
                <Play className="w-5 h-5 mr-2" /> Now Playing
            </button>
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'topRatedMovies' ? 'bg-gray-300' : ''}`}
            ...
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'popularTv' ? 'bg-gray-300' : ''}`}
                onClick={() => handleItemClick('popularTv')}
            >
                <List className="w-5 h-5 mr-2" /> Popular
            </button>
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'onTheAir' ? 'bg-gray-300' : ''}`}
                onClick={() => handleItemClick('onTheAir')}
            >
                <Tv className="w-5 h-5 mr-2" /> On The Air
            </button>
            <button
                className={`flex items-center p-2 hover:bg-gray-500 rounded transition-colors ${activeItem === 'topRatedTv' ? 'bg-gray-300' : ''}`}
