...
export function LoginForm({ onSubmit, onGoogleLogin, isLoading, error }: LoginFormProps) {
    return (
        <div className="flex justify-center items-center min-h-screen font-sans font-medium bg-[url('./img/backgroud_login.jpg')] dark:bg-[url('./img/background_login_dm.jpg')] bg-cover bg-center dark:bg-gray-900">
            <div className="flex flex-col md:rounded-xl justify-center items-center w-[600px] min-h-screen md:min-h-0 md:h-auto md:py-8 bg-white bg-opacity-80 dark:bg-gray-900 md:dark:bg-[#D1D1D1] shadow md:dark:bg-opacity-80 dark:bg-opacity-80">
                <LogoSection />
